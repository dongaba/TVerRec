...
switch ($true) {
	...
	$IsLinux {
		...
		if ($currentVersion -eq $latestVersion) {
			...
			catch { Write-Error ('❌️ ffmpegの展開に失敗しました') ; exit 1 }
