...
powershell -Command "Add-Type -AssemblyName System.Windows.Forms | Out-Null ; [System.Windows.Forms.MessageBox]::Show('日本語化を完了するには再起動が必要です。OKを押すと自動的にWindowsサンドボックスを再起動します。', 'TVerRec')"
