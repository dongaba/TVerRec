...
if exist "C:\Program Files\PowerShell\7\pwsh.exe" (
	...
	powershell -Command "Get-Content -Encoding:utf8 ..\src\common_functions.ps1 | Out-File -Encoding:utf8 ..\src\functions\common_functions_5.ps1 -Force"
	powershell -Command "Get-Content -Encoding:utf8 ..\src\tver_functions.ps1 | Out-File -Encoding:utf8 ..\src\functions\tver_functions_5.ps1 -Force"
	powershell -Command "Get-Content -Encoding:utf8 ..\src\update_ffmpeg.ps1 | Out-File -Encoding:utf8 ..\src\functions\update_ffmpeg_5.ps1 -Force"
	powershell -Command "Get-Content -Encoding:utf8 ..\src\update_ytdl-patched.ps1 | Out-File -Encoding:utf8 ..\src\functions\update_ytdl-patched_5.ps1 -Force"
